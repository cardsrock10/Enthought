...
print "Yearly:", wind_data.resample('A').mean()

print "Monthly:", wind_data.resample('M').mean()

print "Weekly:", wind_data.resample('W').mean()
print
...
stats = wind_data.resample('W').mean().apply(lambda x: x.describe())
